...
const AdminBookDetail = () => {
  ...
  const handleFileChange = (e) => {// ตรวจสอบขนาดไฟล์ (ไม่เกิน 2MB)
    ...
    <div className="">
      <div className="my-1">
        <div className="flex flex-row py-1 mx-auto justify-between ">
          <button  className="bg-green-400 px-5 py-1 rounded-md mx-10 text-white " onClick={handleShowModal}>
            เพิ่มข้อมูล
          </button>
          <input
            type="text"
      ...
      <div className="flex flex-row    justify-center py-2 px-4 md:px-6 xl:px-7.5 ">
        <ReactPaginate
          breakLabel={"..."}
          pageCount={endpoint}
