        ...
        >
          <div className="col-span-2 flex flex-row  items-center">
            <div className="text-md">
              <div>
                <p className="col-span-2 text-md text-black dark:text-white t">
          ...
          <div className="col-span-1 flex items-center">
            <p className="text-sm text-start text-black dark:text-white">
              {book.isbn}
            </p>
          </div>

          <div className="col-span-2 hidden items-center sm:flex">
            <p className="text-sm mx-16  text-black dark:text-white">
              {book.author}
            </p>
          </div>

          <div className="col-span-1  items-center  ">
            <p className="text-sm mx-5 mt-2  text-center text-black dark:text-white">
              {book.location.name}
            </p>
          </div>
